...
export const GuideWithSidebar: Story = () => (
  <div className="-m-6">
    <AppShell
      ...
      header={<PageHeader homeHref="/en" homeLabel="konnect — home" navLabel="Main navigation" menuLabel="Open menu" nav={NAV} currentPath="/guides" actions={<Button size="sm">Sign in</Button>} />}
...
export const WithoutSidebar: Story = () => (
  <div className="-m-6">
    <AppShell skipLabel="Skip to content" header={<PageHeader homeHref="/en" homeLabel="konnect — home" navLabel="Main navigation" menuLabel="Open menu" nav={NAV} currentPath="/questions" />} width="content">
